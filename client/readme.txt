Unsolved problems as at Apr 1 02:26
...
Mitigation 1: Handle by BE


2. How to create a chatroom with unreached recipient?
Significance: entry point to new room
Mitigation 1: add button in "other user profile" as entry point
Mitigation 2: in Chat page add button to do searching first (cf: dialog component), if found user then open chatroom, else alert
