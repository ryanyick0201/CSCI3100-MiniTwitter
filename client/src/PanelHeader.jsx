...
import { Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Button } from '@material-ui/core'; // import for search dialog function
    ...
    return (
        <>
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    <DialogContentText>
                        Search the name of recipient to open a new chatroom and start chatting!
                    </DialogContentText>
                    <Autocomplete
                        id="autocomplete_search"
                        freeSolo
                        options={chattables}
                        renderInput={(params) => <TextField inputRef={formRef} {...params} label="Search whom to chat with..." />}
                    />
                </DialogContent>
                <DialogActions>
                ...
                <Snackbar open={alertVisibility} autoHideDuration={3000} onClose={handleAlertClose} anchorOrigin={{ vertical: 'bottom', horizontal: 'center' }} ClickAwayListenerProps={{ onClickAway: handleAlertClickAway }}>
